...
namespace Chisel.Components
{
    ...
    public sealed class ChiselRevolvedShape : ChiselBranchGeneratorComponent<ChiselRevolvedShapeGenerator, RevolvedShapeSettings, ChiselRevolvedShapeDefinition>
    {
