...
namespace Chisel.Components
{
    ...
    public sealed class ChiselExtrudedShape : ChiselBranchGeneratorComponent<ChiselExtrudedShapeGenerator, ExtrudedShapeSettings, ChiselExtrudedShapeDefinition>
    {
