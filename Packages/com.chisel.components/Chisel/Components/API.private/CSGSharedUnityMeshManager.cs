...
namespace Chisel.Components
{
    ...
    internal sealed class CSGGeneratedRefCountedMesh
    {
        public UnityEngine.Mesh	sharedMesh;
        public int				refCount;
    }
    
    internal sealed class CSGSharedUnityMeshManager
    {
        ...
        {
            CSGGeneratedRefCountedMesh refCountedMesh;
            refCountedMeshes.TryGetValue(meshKey, out refCountedMesh);
            if (refCountedMesh == null)
            {
                refCountedMesh = new CSGGeneratedRefCountedMesh();
