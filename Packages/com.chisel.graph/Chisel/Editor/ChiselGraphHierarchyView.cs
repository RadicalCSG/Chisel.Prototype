...
namespace Chisel.Nodes
{
    ...
    sealed class ChiselGraphHierarchyView : EditorWindow
    {
        ChiselGraphHierarchyView()
        {
            windows.Add(this);
        }
        ...
        static List<ChiselGraphHierarchyView> windows = new List<ChiselGraphHierarchyView>();
        ...
        [MenuItem("Chisel DEBUG/Chisel Graph Hierarchy")]
        static void Create()
        {
            window = (ChiselGraphHierarchyView)EditorWindow.GetWindow(typeof(ChiselGraphHierarchyView), false, "Chisel Graph Hierarchy");
            window.autoRepaintOnSceneChange = true;
        }

        static ChiselGraphHierarchyView window;
