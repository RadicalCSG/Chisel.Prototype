...
namespace UnitySceneExtensions
{
    public sealed partial class SceneHandles
    {
        ...
        internal static int s_Radius2DHash0 = "Radius2DHash0".GetHashCode();
        internal static int s_Radius2DHash1 = "Radius2DHash1".GetHashCode();
        internal static int s_Radius2DHash2 = "Radius2DHash2".GetHashCode();
        internal static int s_Radius2DHash3 = "Radius2DHash3".GetHashCode();
        ...
        {
            var positionId0 = GUIUtility.GetControlID (s_Radius2DHash0, FocusType.Keyboard);
            var positionId1 = GUIUtility.GetControlID (s_Radius2DHash1, FocusType.Keyboard);
            var positionId2 = GUIUtility.GetControlID (s_Radius2DHash2, FocusType.Keyboard);
            var positionId3 = GUIUtility.GetControlID (s_Radius2DHash3, FocusType.Keyboard);
            ...
            if (GUI.changed)
            {
                ...
                position0 = center + delta1;
                position1 = center - delta1;
                position2 = center + delta2;
                position3 = center - delta2;
            }
