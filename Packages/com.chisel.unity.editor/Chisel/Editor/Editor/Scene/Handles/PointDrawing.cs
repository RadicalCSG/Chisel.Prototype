        ...
        static Vector3? GetPointAtPosition(Vector2 mousePosition, Rect dragArea)
        {
            ...
            if (s_CurrentPointIndex == 0)
            {
                    ...
                    s_StartIntersection.plane.normal.sqrMagnitude > 0) // TODO: figure out how this could happen
                {
                    ...
                    var activeGridUp					= Chisel.Editors.Grid.ActiveGrid.Up;
                    var activeGridForward				= Chisel.Editors.Grid.ActiveGrid.Forward;
                    var activeGridCenter				= Chisel.Editors.Grid.ActiveGrid.Center;
                    ...
                    s_Transform = Matrix4x4.TRS(center, activeGridToSurfaceGridRotation, Vector3.one) *
												Chisel.Editors.Grid.ActiveGrid.GridToWorldSpace;
                    s_InvTransform = s_Transform.inverse;
                    s_Snapping2D.Initialize(new Chisel.Editors.Grid(s_Transform), mousePosition, s_StartIntersection.point, UnityEditor.Handles.matrix);
                }
            }
            ...
            if (s_StartIntersection != null)
            {
                ...
                {
					Chisel.Editors.Grid.HoverGrid = s_Snapping2D.WorldSlideGrid;
