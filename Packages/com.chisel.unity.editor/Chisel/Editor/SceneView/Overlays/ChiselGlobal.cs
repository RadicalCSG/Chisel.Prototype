    ...
    class ConvertToBrushesButton : EditorToolbarButton
    {
        ...
        static ChiselNode ConvertTreeNodeToBrushes(GameObject parent, in ChiselSurfaceArray surfaceDefinition, CSGTreeNode node, Vector3 pivotOffset)
        {
            if (node.Type == CSGNodeType.Brush)
            {
                ...
                brushComponent.surfaceArray = newSurfaceDefinition;
        ...
        static bool ConvertBrush(CSGTreeBrush srcBrush, in ChiselSurfaceArray srcSurfaceDefinition, out BrushMesh newBrushMesh, out ChiselSurfaceArray newSurfaceDefinition)
        {
            ...
            newSurfaceDefinition = new ChiselSurfaceArray
            {
