        ...
        public static ShapeExtrusionState Do(Rect dragArea, out Curve2D shape, out float height, out ChiselModelComponent modelBeneathCursor, out Matrix4x4 transformation, Axis axis)
        {
            ...
            { 
                if (!s_ExtrusionMode)
                {
                    ...
                    PointDrawing.PointDrawHandle(dragArea, ref s_Points, out s_Transformation, out s_ModelBeneathCursor, releaseOnMouseUp: true, Chisel.Editors.SceneHandles.OutlinedDotHandleCap);
