...
{
    public delegate JobHandle PerformMeshUpdate(CSGTree tree, List<UnityEngine.Mesh.MeshDataArray> meshDataArrays, ref VertexBufferContents vertexBufferContents, JobHandle dependencies);
    ...
    public static partial class CSGManager
    {
        ...
        public static bool	Flush	(Action beginMeshUpdates, PerformMeshUpdate performMeshUpdate, FinishMeshUpdate finishMeshUpdates) { if (!UpdateAllTreeMeshes(beginMeshUpdates, performMeshUpdate, finishMeshUpdates, out JobHandle handle)) return false; handle.Complete(); return true; }
