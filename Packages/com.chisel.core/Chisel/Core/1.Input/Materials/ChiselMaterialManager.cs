...
namespace Chisel.Core
{
    public sealed class ChiselMaterialManager : ScriptableObject
    {
        ...
        static readonly Dictionary<string, Material>	editorMaterials = new();
        static readonly Dictionary<Color,Material>		colorMaterials	= new();
        ...
        readonly Dictionary<int, Material> idToMaterial = new();
        readonly Dictionary<Material, int> materialToID = new();
        readonly Dictionary<int, PhysicMaterial> idToPhysicMaterial = new();
        readonly Dictionary<PhysicMaterial, int> physicMaterialToID = new();
