...
{ 
    ...
    {   
        ...
        [NoAlias, ReadOnly] public int		    subMeshIndexOffset;
        [NoAlias, ReadOnly] public int		    subMeshIndexCount;
        [NoAlias, ReadOnly] public int		    subMeshVertexOffset;
        ...
        public void Execute()
        {
            ...
            var generatedMeshIndicesSlice       = generatedMeshIndices      .Slice(subMeshIndexOffset, subMeshIndexCount);
            var generatedMeshBrushIndicesSlice  = generatedMeshBrushIndices .Slice(subMeshIndexOffset / 3, subMeshIndexCount / 3);
            var generatedMeshPositionsSlice     = generatedMeshPositions    .Slice(subMeshVertexOffset, subMeshVertexCount);
            var generatedMeshTangentsSlice      = generatedMeshTangents.IsCreated ? generatedMeshTangents.Slice(subMeshVertexOffset, subMeshVertexCount) : default;
            var generatedMeshNormalsSlice       = generatedMeshNormals .IsCreated ? generatedMeshNormals .Slice(subMeshVertexOffset, subMeshVertexCount) : default;
            var generatedMeshUV0Slice           = generatedMeshUV0     .IsCreated ? generatedMeshUV0     .Slice(subMeshVertexOffset, subMeshVertexCount) : default;

            var normals	= needTempNormals ? new NativeArray<float3>(subMeshVertexCount, Allocator.Temp).Slice() : generatedMeshNormalsSlice;
            var uv0s	= needTempUV0     ? new NativeArray<float2>(subMeshVertexCount, Allocator.Temp).Slice() : generatedMeshUV0Slice;
            ...
            { 
                        ...
                        ++surfaceIndex)
                {
                    ...
                    {
                        generatedMeshIndicesSlice[subMeshIndexOffset + indexOffset] = (int)(sourceBuffer.indices[i] + vertexOffset); indexOffset++;
                    }
    ...
    {   
        ...
        [NoAlias, WriteOnly] public NativeSlice<int> generatedMeshBrushIndices;

        [NoAlias] public NativeSlice<int>		generatedMeshIndices;
        [NoAlias] public NativeSlice<float3>    generatedMeshPositions;
        [NoAlias] public NativeSlice<float2>    generatedMeshUV0; 
        [NoAlias] public NativeSlice<float3>    generatedMeshNormals;

        [NoAlias, WriteOnly] public NativeSlice<float4>    generatedMeshTangents;
        ...
        public void Execute()
        {
            ...
            { 
                        ...
                        ++surfaceIndex)
                {
                    ...
                    generatedMeshUV0.CopyFrom(vertexOffset, ref sourceBuffer.uv0, 0, sourceVertexCount);
                    generatedMeshNormals.CopyFrom(vertexOffset, ref sourceBuffer.normals, 0, sourceVertexCount);
                    vertexOffset += sourceVertexCount;
                }
            }
